...
<html lang="en">
    <head>
        ...
        <title>Entregas Vila da Folha</title>
    </head>
    <body>
        <?php 
            $pessoa =[
            ...
            cadatras_ninja($pessoa['nome'],$pessoa['cla']);
            missoes($pessoa['nome'],$pessoa['nivel']);
            function cadatras_ninja($nome,$valor){
                switch($valor){
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        echo "Numero invalido, o Hokage não sabe qual clã você pertecen";
                        break;
                }
            }
            ...
            function missoes($nome,$valor){
                $mensagem = "Bem Vindo, $nome, sua missao é ";
                if($valor == 1){
                    $mensagem .= "Rank D (tarefas simples, ajudar aldeões).";
                }elseif($valor == 2){
                    $mensagem .= "Rank C (baixo risco, escoltas curtas).";
                }elseif($valor == 3){
                    $mensagem .= "Rank B (risco médio, confronto com ninjas).";
                }elseif($valor == 4){
                    $mensagem .= "Rank A (alto risco, operações críticas).";
                }elseif($valor == 5){
                    $mensagem .= "Rank S (secretas, extremamente perigosas).";
                }else{
                    $mensagem = "Você não pode receber missoes";
                }
                echo $mensagem;
            }
